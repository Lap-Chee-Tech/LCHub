...
export default {
  ...
  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? "#007aff" : "#007aff",
  ...
  toolbarBtnTextColor: platform === PLATFORM.IOS ? "#007aff" : "#007aff",
  ...
  listNoteSize: 13,
  listItemSelected: platform === PLATFORM.IOS ? "#007aff" : "#007aff",
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? "#F8F8F8" : "#F8F8F8",
  ...
  // Tab
  tabDefaultBg: platform === PLATFORM.IOS ? "#F8F8F8" : "#F8F8F8",
